...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
		<div class="container">
			...
			<a class="navbar-brand" href="/ProyectGamesWeb">
			...
			<div id="btnsbar">
				...
				<a href="views/Carrito.jsp" class="btn btn-warning ml-lg-3"
			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<a class="navbar-brand" href="/ProyectGamesWeb">GameStore</a>
			...
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<a href="/DetailsProducts.jsp" class="btn btn-primary">Ver</a>
					</div>
				</div>
			</div>
		</template>
